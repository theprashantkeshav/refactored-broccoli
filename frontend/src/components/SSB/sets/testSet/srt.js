...
const SRTSets = () => {
  ...
  return (
    <div>
      ...
      <Navbar />
      <Title title="SRT Test Sets" />
      <div className="sets">
        <CardTwo
          img="/images/icons/set.png"
          title="Set 1"
          url="/situation-reaction-test-srt-instruction/one"
        />
        <CardTwo
          img="/images/icons/set.png"
          title="Set 2"
          url="/situation-reaction-test-srt-instruction/two"
        />
        <CardTwo
          img="/images/icons/set.png"
          title="Set 3"
          url="/situation-reaction-test-srt-instruction/three"
        />
        <CardTwo
          img="/images/icons/set.png"
          title="Set 4"
          url="/situation-reaction-test-srt-instruction/four"
        />
        <CardTwo
          img="/images/icons/set.png"
          title="Set 5"
          url="/situation-reaction-test-srt-instruction/five"
        />
      </div>
    </div>
  );
